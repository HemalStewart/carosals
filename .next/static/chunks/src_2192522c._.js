...
const ExpoSliderPremium = (param)=>{
    ...
    const [rotate, setRotate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ExpoSliderPremium.useEffect": ()=>{
            let swiper;
            const initSwiper = {
                "ExpoSliderPremium.useEffect.initSwiper": async ()=>{
                    // Wait for module
                    const { default: EffectExpo } = await __turbopack_context__.A("[project]/src/lib/effect-expo.esm.js [app-client] (ecmascript, async loader)");
                    // Wait for images to load
                    await new Promise({
                        "ExpoSliderPremium.useEffect.initSwiper": (resolve)=>{
                            var _swiperRef_current;
                            const imgs = ((_swiperRef_current = swiperRef.current) === null || _swiperRef_current === void 0 ? void 0 : _swiperRef_current.querySelectorAll('img')) || [];
                            let loaded = 0;
                            if (imgs.length === 0) resolve();
                            imgs.forEach({
                                "ExpoSliderPremium.useEffect.initSwiper": (img)=>{
                                    if (img.complete) {
                                        loaded++;
                                        if (loaded === imgs.length) resolve();
                                    } else {
                                        img.onload = ({
                                            "ExpoSliderPremium.useEffect.initSwiper": ()=>{
                                                loaded++;
                                                if (loaded === imgs.length) resolve();
                                            }
                                        })["ExpoSliderPremium.useEffect.initSwiper"];
                    ...
                    // Initialize fresh Swiper
                    swiper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$swiper$2d$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__S__as__default$3e$__["default"](swiperRef.current, {
                        modules: [
                            EffectExpo
                        ],
                        effect: 'expo',
                        direction,
                        slidesPerView: direction === 'horizontal' ? 1.5 : 1.9,
                        centeredSlides: true,
                        grabCursor: true,
                        spaceBetween: 16,
                        loop: true,
            ...
            initSwiper();
            return ({
                "ExpoSliderPremium.useEffect": ()=>swiper === null || swiper === void 0 ? void 0 : swiper.destroy(true, true)
            })["ExpoSliderPremium.useEffect"];
        }
    }["ExpoSliderPremium.useEffect"], [
        direction,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        className: "demo-nav-rotate ".concat(rotate ? 'active' : ''),
...
_s(ExpoSliderPremium, "ippmn4awe2TwJOT40LnO7fmRmOo=");
...
//# sourceMappingURL=src_2192522c._.js.map