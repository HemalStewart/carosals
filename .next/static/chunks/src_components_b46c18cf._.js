...
const CardStackCarousel = (param)=>{
    let { onPosterClick } = param;
    _s();
    ...
    const getTransform = (index)=>{
        ...
        return {
            transform: "translate(".concat(x, "px, ").concat(y + radius, "px) translate(-50%, -50%) scale(").concat(scale, ")"),
            filter,
            opacity,
...
_s(CardStackCarousel, "kgdTHTZ1XQu2bBLKBehOXZj7+p0=");
...
//# sourceMappingURL=src_components_b46c18cf._.js.map