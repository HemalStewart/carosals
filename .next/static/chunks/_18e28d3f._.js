...
const Carousel = (param)=>{
    let { posters, scrollProgress } = param;
    _s();
    ...
    const carouselTransform = "translateX(".concat(100 * (1 - carouselT), "px)"); // Slides from the right
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: {
                    width: "".concat(posters.length * 220, "px")
                },
...
_s(Carousel, "6CRrwZHYK9uO48fX4or0s9sBNOc=");
_c = Carousel;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Carousel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/Carousel.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const CardStackCollection = ()=>{
    ...
    // All posters for Section 3 (15 items)
    const posters = [
        {
            id: 1,
    ...
    // First 6 posters for Section 1 & 2
    const collections = posters.slice(0, 6);
    // Deterministic messy offsets for the initial 6 posters
    ...
    // Card style: Section1 → Section2 → Single Card Remains & Fades Out
    const getCardStyle = (index, total)=>{
        const baseZIndex = total - index;
        let t = scrollProgress * 4; // Map scroll progress to 4 phases
        const centerIndex = Math.floor(collections.length / 2); // 3rd card for a 6-card array (index 2)
        if (t < 1) {
            // Section 1: messy stack
            const { offsetX = 0, offsetY = 0, rotation = 0 } = cardOffsets[index] || {};
            return {
                transform: "translateX(".concat(format(offsetX * (1 - t) + (index - (collections.length - 1) / 2) * 200 * t), "px) translateY(").concat(format(offsetY * (1 - t)), "px) rotate(").concat(format(rotation * (1 - t) + (index - (collections.length - 1) / 2) * 3 * t), "deg)"),
                zIndex: baseZIndex,
                transition: "transform 0.5s ease-out"
            };
        } else if (t < 2) {
            // Section 2: spread stack
            const spreadT = t - 1;
            const spreadDistance = 200;
            const angle = (index - (collections.length - 1) / 2) * 3 * (1 - spreadT);
            return {
                transform: "translateX(".concat((index - (collections.length - 1) / 2) * spreadDistance, "px) translateY(0px) rotate(").concat(angle, "deg)"),
                zIndex: hoveredCard === index ? baseZIndex + 1000 : baseZIndex + 500,
                transition: "transform 0.5s ease-out"
            };
        } else if (t < 3) {
            // Section 2 to 3 transition: single card remains and all others disappear
            const transitionT = t - 2;
            const scale = index === centerIndex ? 1 : Math.max(0, 1 - transitionT);
            const opacity = index === centerIndex ? 1 : Math.max(0, 1 - transitionT);
            const spreadDistance = 200;
            return {
                transform: "translateX(".concat((index - (collections.length - 1) / 2) * spreadDistance, "px) scale(").concat(scale, ")"),
                opacity: opacity,
                zIndex: hoveredCard === index ? baseZIndex + 1000 : baseZIndex + 500,
                transition: "transform 0.5s ease-out, opacity 0.5s ease-out"
            };
        } else {
            // Section 3: all initial cards are hidden
            return {
                transform: "scale(0)",
                opacity: 0,
                zIndex: -1,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "h-screen w-full snap-start bg-gray-50 relative overflow-hidden",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute top-20 left-1/2 transform -translate-x-1/2 text-center z-10 pointer-events-none",
                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Carousel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                posters: posters,
...
//# sourceMappingURL=_18e28d3f._.js.map