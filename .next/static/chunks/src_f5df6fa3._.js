...
// ✅ Poster-level animation variants
...
function CarouselPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CarouselPage.useEffect": ()=>{
            const observers = [];
            sections.forEach({
                "CarouselPage.useEffect": (sectionRef, index)=>{
                    const observer = new IntersectionObserver({
                        "CarouselPage.useEffect": (param)=>{
                            let [entry] = param;
            ...
            return ({
                "CarouselPage.useEffect": ()=>observers.forEach({
                        "CarouselPage.useEffect": (obs)=>obs.disconnect()
                    }["CarouselPage.useEffect"])
            })["CarouselPage.useEffect"];
        }
    }["CarouselPage.useEffect"], []);
...
_s(CarouselPage, "uDqJwaTcTWzcdVZ4xvPLL4bkKc0=", false, function() {
    return [
...
//# sourceMappingURL=src_f5df6fa3._.js.map