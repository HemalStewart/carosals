...
const CardStackCollection = ()=>{
    ...
    const [isExpanding, setIsExpanding] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const getCardStyle = (index, total)=>{
        ...
        if (t >= 3 && selectedCard && selectedCard.id === collections[index].id) {
            ...
            transformValue = "translateX(-".concat(window.innerWidth * 0.25, "px) translateY(0px) rotate(0deg) scale(").concat(targetScale, ")");
            opacity = 1;
            ...
            transformValue = "translateX(".concat(finalCarouselPosition, "px) translateY(0px) rotate(0deg) scale(0.8)");
            opacity = 0;
            zIndex = baseZIndex;
        } else if (t < 1) {
    ...
    const handleCardClick = (collection)=>{
        ...
        if (t > 2) {
            if (t > 3 && (selectedCard === null || selectedCard === void 0 ? void 0 : selectedCard.id) === collection.id) {
                // If already in section 4 and clicking the same card, navigate to detail page
                router.push("/posters/".concat(collection.id, "?src=").concat(collection.src, "&title=").concat(collection.title));
            } else {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "absolute inset-0 flex items-center justify-center p-8 transition-opacity duration-500 ".concat(selectedCard ? 'opacity-100' : 'opacity-0 pointer-events-none'),
                            children: selectedCard && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CardStackCollection, "4mEHryLKiQ+Jj4Z5cYS/j348GPs=", false, function() {
    return [
...
//# sourceMappingURL=_c4bf84e4._.js.map