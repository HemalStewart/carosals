...
"[project]/src/lib/effect-expo.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$swiper$2d$effect$2d$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/swiper/swiper-effect-utils.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$effect$2d$init$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__e__as__effectInit$3e$__ = __turbopack_context__.i("[project]/node_modules/swiper/shared/effect-init.mjs [app-client] (ecmascript) <export e as effectInit>");
;
if ("object" !== 'undefined' && window.SwiperElementRegisterParams) {
    window.SwiperElementRegisterParams([
        'expoEffect'
...
function EffectExpo(param) {
    ...
    const setTranslate = ()=>{
        ...
        for(let i = 0; i < slides.length; i += 1){
            ...
            if (imageEl) {
                imageEl.style.transform = "translate".concat(isHorizontal ? 'X' : 'Y', "(").concat(progressLimited * translateOffset * 100 * rtlMultiplier, "%) scale(").concat(1 + (imageScale - 1) * Math.abs(progressLimited), ")");
                if (params.grayscale) {
                    imageEl.style.filter = "grayscale(".concat(Math.abs(progressLimited), ")");
                }
            }
            ...
            if (contentWrapEl) {
                contentWrapEl.style.transform = "scale(".concat(1 + (scale - 1) * Math.abs(progressLimited), ") rotate").concat(isHorizontal ? 'Y' : 'X', "(").concat(params.rotate * progressLimited * (isHorizontal ? 1 : -1) * rtlMultiplier, "deg)");
            }
            if (contentEl) {
                contentEl.style.transform = "translate".concat(isHorizontal ? 'X' : 'Y', "(").concat(progressLimited * 100 * rtlMultiplier, "%)");
    ...
    const setSize = ()=>{
        ...
        swiper.el.style.setProperty('--expo-padding', "".concat(newValue, "px"));
    };
    on('init', setSize);
    on('resize', setSize);
    on('update', setSize);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$effect$2d$init$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__e__as__effectInit$3e$__["effectInit"])({
        effect: 'expo',
        swiper,
        on,
        setTranslate,
...
_c = EffectExpo;
var _c;
__turbopack_context__.k.register(_c, "EffectExpo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/ExpoSliderPremium.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$effect$2d$expo$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/effect-expo.esm.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
;
;
const ExpoSliderPremium = (param)=>{
    let { slides } = param;
    _s();
    const swiperRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const swiperInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ExpoSliderPremium.useEffect": ()=>{
            // ✅ Destroy old instance if exists
            if (swiperInstance.current) swiperInstance.current.destroy(true, true);
            // ✅ Initialize new instance
            swiperInstance.current = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$swiper$2d$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__S__as__default$3e$__["default"](swiperRef.current, {
                modules: [
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$effect$2d$expo$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
                ],
                effect: 'expo',
                direction: 'vertical',
                slidesPerView: 1.5,
            ...
            return ({
                "ExpoSliderPremium.useEffect": ()=>{
                    var _swiperInstance_current;
                    return (_swiperInstance_current = swiperInstance.current) === null || _swiperInstance_current === void 0 ? void 0 : _swiperInstance_current.destroy(true, true);
                }
            })["ExpoSliderPremium.useEffect"];
        }
    }["ExpoSliderPremium.useEffect"], []);
...
_s(ExpoSliderPremium, "lgqkPdYe4aiRFLcYUIdj3BYPrZA=");
_c = ExpoSliderPremium;
const __TURBOPACK__default__export__ = ExpoSliderPremium;
var _c;
__turbopack_context__.k.register(_c, "ExpoSliderPremium");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/TripleSlider.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TripleSlider() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TripleSlider.useEffect": ()=>{
            ...
            let mainSwiper;
            const prevSwiper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$swiper$2d$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__S__as__default$3e$__["default"](swiperPrevEl, {
                ...common,
                allowTouchMove: false,
                on: {
                    click: {
                        "TripleSlider.useEffect": ()=>mainSwiper.slidePrev()
                    }["TripleSlider.useEffect"]
                }
            });
            const nextSwiper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$swiper$2d$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__S__as__default$3e$__["default"](swiperNextEl, {
                ...common,
                allowTouchMove: false,
                on: {
                    click: {
                        "TripleSlider.useEffect": ()=>mainSwiper.slideNext()
                    }["TripleSlider.useEffect"]
                }
            });
            mainSwiper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$swiper$2d$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__S__as__default$3e$__["default"](swiperEl, {
                ...common,
                grabCursor: true,
                controller: {
                    control: [
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: slides.map((s, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                className: "logo-image ".concat(s.logoClass),
...
_s(TripleSlider, "8puyVO4ts1RhCfXUmci3vLI3Njw=");
_c = TripleSlider;
var _c;
__turbopack_context__.k.register(_c, "TripleSlider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_a71a1cf8._.js.map